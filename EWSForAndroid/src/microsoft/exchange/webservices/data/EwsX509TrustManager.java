...
class EwsX509TrustManager implements X509TrustManager
{
	...
	/**
	 * @see com.innovaturelabs.net.ssl.X509TrustManager#checkClientTrusted(X509Certificate[],String authType)
	 */
	...
	/**
	 * @see com.innovaturelabs.net.ssl.X509TrustManager#checkServerTrusted(X509Certificate[],String authType)
	 */
	...
	/**
	 * @see com.innovaturelabs.net.ssl.X509TrustManager#getAcceptedIssuers()
	 */
