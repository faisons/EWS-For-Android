...
import com.innovaturelabs.xml.stream.util.XMLEventAllocator;
 ...
 *        <th>Required</th>
 *      </tr>
 * <tr><td>com.innovaturelabs.xml.stream.isValidating</td><td>Turns on/off implementation specific DTD validation</td><td>Boolean</td><td>False</td><td>No</td></tr>
 * <tr><td>com.innovaturelabs.xml.stream.isNamespaceAware</td><td>Turns on/off namespace processing for XML 1.0 support</td><td>Boolean</td><td>True</td><td>True (required) / False (optional)</td></tr>
 * <tr><td>com.innovaturelabs.xml.stream.isCoalescing</td><td>Requires the processor to coalesce adjacent character data</td><td>Boolean</td><td>False</td><td>Yes</td></tr>
 * <tr><td>com.innovaturelabs.xml.stream.isReplacingEntityReferences</td><td>replace internal entity references with their replacement text and report them as characters</td><td>Boolean</td><td>True</td><td>Yes</td></tr>
 *<tr><td>com.innovaturelabs.xml.stream.isSupportingExternalEntities</td><td>Resolve external parsed entities</td><td>Boolean</td><td>Unspecified</td><td>Yes</td></tr>
 *<tr><td>com.innovaturelabs.xml.stream.supportDTD</td><td>Use this property to request processors that do not support DTDs</td><td>Boolean</td><td>True</td><td>Yes</td></tr>
 *<tr><td>com.innovaturelabs.xml.stream.reporter</td><td>sets/gets the impl of the XMLReporter </td><td>com.innovaturelabs.xml.stream.XMLReporter</td><td>Null</td><td>Yes</td></tr>
 *<tr><td>com.innovaturelabs.xml.stream.resolver</td><td>sets/gets the impl of the XMLResolver interface</td><td>com.innovaturelabs.xml.stream.XMLResolver</td><td>Null</td><td>Yes</td></tr>
 *<tr><td>com.innovaturelabs.xml.stream.allocator</td><td>sets/gets the impl of the XMLEventAllocator interface</td><td>com.innovaturelabs.xml.stream.util.XMLEventAllocator</td><td>Null</td><td>Yes</td></tr>
 *    </tbody>
 *  </table>
 *
 *
 ...
 * @see XMLReporter
 * @see XMLResolver
 * @see com.innovaturelabs.xml.stream.util.XMLEventAllocator
 */
...
public abstract class XMLInputFactory {
  ...
  public static final String IS_NAMESPACE_AWARE=
    "com.innovaturelabs.xml.stream.isNamespaceAware";

  /** 
   * The property used to turn on/off implementation specific validation 
   */
  public static final String IS_VALIDATING=
    "com.innovaturelabs.xml.stream.isValidating";
  
  /** 
   * The property that requires the parser to coalesce adjacent character data sections 
   */
  public static final String IS_COALESCING=
    "com.innovaturelabs.xml.stream.isCoalescing";
  ...
  public static final String IS_REPLACING_ENTITY_REFERENCES=
    "com.innovaturelabs.xml.stream.isReplacingEntityReferences";
  
  /** 
   *  The property that requires the parser to resolve external parsed entities
   */
  public static final String IS_SUPPORTING_EXTERNAL_ENTITIES=
    "com.innovaturelabs.xml.stream.isSupportingExternalEntities";

  /** 
   *  The property that requires the parser to support DTDs
   */
  public static final String SUPPORT_DTD=
    "com.innovaturelabs.xml.stream.supportDTD";
  ...
  public static final String REPORTER=
    "com.innovaturelabs.xml.stream.reporter";

  /**
   * The property used to set/get the implementation of the XMLResolver
   */
  public static final String RESOLVER=
    "com.innovaturelabs.xml.stream.resolver";
  
  /**
   * The property used to set/get the implementation of the allocator
   */
  public static final String ALLOCATOR=
    "com.innovaturelabs.xml.stream.allocator";
   ...
   * Use the com.innovaturelabs.xml.stream.XMLInputFactory system property. 
   ...
   * The Services API will look for a classname in the file META-INF/services/com.innovaturelabs.xml.stream.XMLInputFactory 
