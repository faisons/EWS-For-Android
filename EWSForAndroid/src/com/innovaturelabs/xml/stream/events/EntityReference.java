 ...
 * available).  This event will be reported if com.innovaturelabs.xml.stream.isReplacingEntityReferences 
 * is set to false.  If com.innovaturelabs.xml.stream.isReplacingEntityReferences is set to true
 * entity references will be resolved transparently.
 *
 * Entities are handled in two possible ways:
 *
 * (1) If com.innovaturelabs.xml.stream.isReplacingEntityReferences is set to true
 * all entity references are resolved and reported as markup transparently.
 * (2) If com.innovaturelabs.xml.stream.isReplacingEntityReferences is set to false
