 ...
 *
 * If com.innovaturelabs.xml.stream.isPrefixDefaulting is set to false it is a fatal error if an element
 * is written with namespace URI that has not been bound to a prefix.
 *
 * If com.innovaturelabs.xml.stream.isPrefixDefaulting is set to true the XMLStreamWriter implementation
...
public interface XMLStreamWriter {
   ...
   * com.innovaturelabs.xml.stream.isPrefixDefaulting has not been set to true
   */
