 ...
 * com.innovaturelabs.xml.stream.notations and com.innovaturelabs.xml.stream.entities.
 * When the current event is a DTD the following call will return a
 * list of Notations
 *  <code>List l = (List) getProperty("com.innovaturelabs.xml.stream.notations");</code>
 * The following call will return a list of entity declarations:
 * <code>List l = (List) getProperty("com.innovaturelabs.xml.stream.entities");</code>
 ...
 * @see com.innovaturelabs.xml.stream.events.XMLEvent
 * @see XMLInputFactory
 * @see XMLStreamWriter
 */
public interface XMLStreamReader extends XMLStreamConstants {
   ...
   * If the property com.innovaturelabs.xml.stream.isCoalescing is set to true
   ...
   * Regardless of value of com.innovaturelabs.xml.stream.isCoalescing this method always returns coalesced content.
